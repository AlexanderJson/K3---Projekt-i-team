 ...
 * @returns {Promise<void>}
 */
export async function loadDemoByKey(key) {
  const loaders = {
...
export async function loadDemoWorkspace() {
  const state = loadState();
  state.tasks   = prepareTasks(createTechTasks(), techContacts);
  state.people  = withDefaultMembers(techPeople);
  if (!state.settings) state.settings = {};
...
export async function loadDemoLIA() {
  const state = loadState();
  state.tasks   = prepareTasks(createLiaTasks(), liaContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoWedding() {
  const state = loadState();
  state.tasks   = prepareTasks(createWeddingTasks(), weddingContacts);
...
export async function loadDemoSales() {
  const state = loadState();
  state.tasks   = prepareTasks(createSalesTasks(), salesContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoFamily() {
  const state = loadState();
  state.tasks   = prepareTasks(createFamilyTasks(), familyContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoEvent() {
  const state = loadState();
  state.tasks   = prepareTasks(createEventTasks(), eventContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoRealEstate() {
  const state = loadState();
  state.tasks   = prepareTasks(createRealEstateTasks(), realEstateContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoICA() {
  const state = loadState();
  state.tasks   = prepareTasks(createICATasks(), icaContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoRentFint() {
  const state = loadState();
  state.tasks   = prepareTasks(createRentFintTasks(), rentFintContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoGym() {
  const state = loadState();
  state.tasks   = prepareTasks(createGymTasks(), gymContacts);
 ...
 * @returns {Promise<void>}
 */
export async function loadDemoBygg() {
  const state = loadState();
  state.tasks   = prepareTasks(createByggTasks(), byggContacts);
